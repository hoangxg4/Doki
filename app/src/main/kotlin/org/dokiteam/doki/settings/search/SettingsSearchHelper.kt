...
import org.koitharu.doki.settings.sources.SourcesSettingsFragment
...
class SettingsSearchHelper @Inject constructor(
	...
	fun inflatePreferences(): List<SettingsItem> {
		...
		preferenceManager.inflateTo(result, R.xml.pref_sources, emptyList(), org.koitharu.doki.settings.sources.SourcesSettingsFragment::class.java)
		...
		preferenceManager.inflateTo(
			...
			org.koitharu.doki.settings.sources.SourcesSettingsFragment::class.java,
		)
		return result
	}
