...
data class HistorySyncDto(
	...
	@SerialName("manga") val manga: org.dokiteam.doki.sync.data.model.MangaSyncDto,
) {

	constructor(cursor: Cursor, manga: org.dokiteam.doki.sync.data.model.MangaSyncDto) : this(
