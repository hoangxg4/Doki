package org.dokiteam.doki.sync.data.model
...
data class MangaSyncDto(
	...
	@SerialName("tags") val tags: Set<org.dokiteam.doki.sync.data.model.MangaTagSyncDto>,
	@SerialName("state") val state: String?,
	@SerialName("author") val author: String?,
	@SerialName("source") val source: String,
) {

	constructor(cursor: Cursor, tags: Set<org.dokiteam.doki.sync.data.model.MangaTagSyncDto>) : this(
